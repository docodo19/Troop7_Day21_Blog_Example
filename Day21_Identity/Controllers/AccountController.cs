...
using Day21_Identity.Providers;
using Day21_Identity.Results;

namespace Day21_Identity.Controllers
{
    [Authorize]
    ...
    public class AccountController : ApiController
    {
        ...
        public async Task<IHttpActionResult> Register(RegisterBindingModel model)
        {
            ...
            // Create a new user based on the information that came from the client side
            var user = new ApplicationUser() {
                UserName = model.Email,
                Email = model.Email,
                FirstName = model.FirstName,  // added 
                LastName = model.LastName  // added
            };
